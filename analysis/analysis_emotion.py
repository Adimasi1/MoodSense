...
def analyze_emotion_batch(texts: List[str], batch_size: int = 128, use_gpu: bool = False) -> List[Dict[str, float]]:
    """
    Analyzes emotions for a batch of texts using GoEmotions (28 emotions).
    
    Args:
        texts: List of text strings
        batch_size: Number of texts to process at once (default: 128 for ONNX)
